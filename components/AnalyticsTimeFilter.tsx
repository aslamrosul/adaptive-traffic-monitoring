        ...
        {showCustomPicker && (
          <>
            ...
            <motion.div
              ...
              className="hidden sm:block fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-white rounded-2xl shadow-2xl p-6 z-50 mx-4"
            >
            ...
            >
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) => setStartDate(e.target.value)}
                      max={endDate}
                      className="w-full pl-10 pr-4 py-4 border-2 border-slate-300 rounded-xl text-base font-semibold focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
                    />
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-slate-50 rounded-xl p-4 border border-blue-100">
                  ...
                  <p className="text-base font-bold text-slate-900">
                    {new Date(startDate).toLocaleDateString('id-ID', { day: 'numeric', month: 'short' })} - {new Date(endDate).toLocaleDateString('id-ID', { day: 'numeric', month: 'short' })}
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-3 mt-8 pb-4">
                <button
                  onClick={() => setShowCustomPicker(false)}
                  className="flex-1 px-4 py-4 text-slate-700 hover:bg-slate-100 rounded-xl font-bold text-base transition-colors border-2 border-slate-200"
                >
                  Batal
                </button>
                <button
