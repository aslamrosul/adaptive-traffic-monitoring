...
export default function TrafficControlPanel({
  ...
  return (
    <div className="space-y-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-lg lg:p-5">
      ...
      {/* V6.7.4: tanpa telemetri controller -> unavailable/stale. Jangan
          mensintesis all-red dari record vision yang tidak punya field lampu. */}
      {!data && (
        <div className="rounded-xl border border-amber-200 bg-amber-50 px-3 py-2 text-xs font-semibold text-amber-800">
          Data controller tidak tersedia (stale/unavailable) — status lampu
